class Car {
  // v2 syntax
  areLightsOn = false;
  // functia care ruleaza cand creeam o instanta
  constructor(
    make,
    color,
    wheels,
    ...
    // this este o referinta catre locatia in memorie a instantei curente
    this.make = make;
    this.color = color;
    this.wheels = wheels;
    this.speed = speed;
  ...
  setSpeed(speed = 0) {
    if (speed > this.topSpeed) {
      ...
      // opreste executia functiei in anumite conditii
      return;
    }
  ...
  flashLights() {
    this.turnLightsOn();
    // v1 for preserving this otherwise it will turn into no
    const self = this;
...
Metoda trebuie sa verifice ca nu se depasesc limitele inferioare si superioare, caz in care se folosesc
...
Adauga o metoda numita flashLights() care sa apeleze cele doua metode in succesiune, folosind metoda setTimeout().
 */
