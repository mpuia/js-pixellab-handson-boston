...
console.warn(`
Afiseaza propozitia:
“Prietenii mei sunt Larry, Steven si Carol.”
...
`);
Object.keys(person.skills).forEach(function (key) {
  console.log(`${key}`);
});

console.warn(`
Prin aceeasi metoda, afiseaza o lista cu
numele complet al prietenilor.
`);
Object.keys(person.friends).forEach(function (key) {
  var friend = person.friends[key];
