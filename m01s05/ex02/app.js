...
Foloseste variabile.
`);
var squareSurface1 = calculateRectangleArea(15, 31);
console.log(squareSurface1);

var squareSurface2 = calculateRectangleArea(8, 9);
console.log(squareSurface2);

var squareSurface3 = calculateRectangleArea(10, 5);
console.log(squareSurface3);

var totalSquare = squareSurface1 + squareSurface2 + squareSurface3;
